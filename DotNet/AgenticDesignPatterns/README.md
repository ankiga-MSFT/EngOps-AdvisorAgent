...
| Model        | Context Window (Token Size) | Max Output Tokens | TPM (Typical Range) |
|--------------|-----------------------------|-------------------|---------------------|
| GPT-4o mini  | 128,000 tokens              | 16,384            | 200K → 10M TPM      |
| GPT-4o       | 128,000 tokens              | ~16K              | 30K → 2M TPM        |
| GPT-5.2      | ~400,000 tokens             | Not specified     | 500K → 40M TPM      |
| GPT-5.4      | ~400,000 tokens             | Up to ~128K       | 500K → 4M TPM       |