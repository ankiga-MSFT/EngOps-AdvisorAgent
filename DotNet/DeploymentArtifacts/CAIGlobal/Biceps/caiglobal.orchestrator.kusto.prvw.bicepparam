...
param PeventHubNameResourceIdsConsumerMappings = [{
  eventhubResourceId:'/subscriptions/86612d19-f7d0-48b5-85d4-ae2f603a842e/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.EventHub/namespaces/ehns-icm-srevent-${env}-ccan/eventhubs/srchange'
...
param pkustoManagedPrivateEndpointConnectionMapping = [{
  ...
  resourceId: '/subscriptions/86612d19-f7d0-48b5-85d4-ae2f603a842e/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.EventHub/namespaces/ehns-icm-srevent-${env}-ccan'
}
{
  kustoConnectionKind: 'CosmosDb'
  managePrivateEndpointName: 'mpe-ratiolinkage-cosmos'
  message: 'Please approve the connection'
  resourceId: '/subscriptions/86612d19-f7d0-48b5-85d4-ae2f603a842e/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.DocumentDB/databaseAccounts/csms-caiglobal-${env}-cm'
}]
param PdeployKustoManagedPrivateEndpoint = 'true'

param PcosmodbresourceIdsPrincipleMappings = [{
  cosmosDbAccountResourceId: '/subscriptions/86612d19-f7d0-48b5-85d4-ae2f603a842e/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.DocumentDB/databaseAccounts/csms-caiglobal-${env}-cm'
  roleDefinitionId: '00000000-0000-0000-0000-000000000001'
  principleId: 'f0557ffa-0659-419b-b89d-344c05f4b5bf'
  appName: 'icmratio'
...
param PkustoResourceIdsPrincipleMappings =  [{kustoDatabaseName:'ICMRatioData',principleid:'be55f430-c2ad-4523-88f4-8f97b0d7237e',tenantid:'72f988bf-86f1-41af-91ab-2d7cd011db47',role:'Admin',principleType:'User'},{kustoDatabaseName:'ICMRatioData',principleid:'21ca88c9-f159-4c8e-8264-a7fa3855d542',tenantid:'72f988bf-86f1-41af-91ab-2d7cd011db47',role:'Admin',principleType:'User'},{kustoDatabaseName:'ICMRatioData',principleid:'30ab5b72-08cc-4f8c-ab3a-5008438c384b',tenantid:'33e01921-4d64-4f8c-a055-5bdaffd5e33d',role:'Admin',principleType:'App'},{kustoDatabaseName:'SupportValidationData',principleid:'30ab5b72-08cc-4f8c-ab3a-5008438c384b',tenantid:'33e01921-4d64-4f8c-a055-5bdaffd5e33d',role:'Admin',principleType:'App'}]
