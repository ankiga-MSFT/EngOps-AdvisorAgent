...
var PeventHubNamespaceSkuCapacity = '6'
...
var PcosmosdbDatabaseCollectionsThroughputMapping = [
  ...
  {collectionFullName:'csms-caiglobal-${env}-cm/CXOAI/ConversationStore',collectionName:'ConversationStore',partitionKey:'UserId',maxThroughput:'30000',defaultTtl:-1}
...
var PCosmosBackupPolicyTier ='Continuous30Days' 
var PvectorEmbeddingCollections = [
  {collectionFullName:'csms-caiglobal-${env}-cm/CXOAI/MemoryStore',collectionName:'MemoryStore',partitionKey:'UserId',maxThroughput:'30000',defaultTtl:-1,embeddingPath:'/embedding',embeddingDataType:'float32',embeddingDimensions:512,embeddingDistanceFunction:'cosine',vectorIndexType:'quantizedFlat',quantizationByteSize:64}
]
...
param Pev2AssistedIdentityAppObjectId =  '3a683f68-852e-42b0-8d0c-10c14ef8c029' //sdp-caiglobal-prod-ev2 enterprise app object id 
param PgenevaMSAppServiceObjectId='6d13ad0e-4b5d-4052-9fbd-af43e9d729d8'
param PdeployKeyvaultCertificates = 'true'
param assistedIdentityKeyVaultName =  'kv-nrtglbev2-${env}-eastus'  //replace
param commandsToExecuteInShell =  ['/bin/bash','-c','pwsh KeyVaultPublicAccessChange.ps1']
param ev2KeyVaultResourceGroupName =  'rg-nrtglobal-${env}-eastus'  //replace
param Pev2PackageName =  'package.zip'
// param PmuiEv2RgIdentityClientId =  '4b304bbb-0805-47aa-8b5f-53e1d035a146'  //mui enterprise app id
// param PmuiEv2RgResourceId =  '/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-nrtglobal-${env}-eastus/providers/Microsoft.ManagedIdentity/userAssignedIdentities/mui-nrtglobal-${env}-eastus'
...
param PcertKeyvaultSecureId =  'https://kv-nrtglbev2-${env}-eastus.vault.azure.net/secrets/ADFEv2DeploymentAssistedIdentityCert'
param PcertificateName =  'sdp-geneva-auth-certificate'  //replace
param PcnSubjectName =  '${env}.geneva.keyvault.cxpes.microsoft.com'
param Pev2ApplicationAppId='381f4f45-70c1-4bb1-899b-d189cda2c182'  //replace
