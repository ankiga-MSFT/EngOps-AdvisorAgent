...
param PkustoClusterResourceId = '/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-Support-wus3-${env}/providers/Microsoft.Kusto/clusters/supportadxwus3${env}'
param PkustoDatabaseNames = ['ICMRatioData']
param PdeployICMRatioData = 'true'

param PeventHubNameResourceIdsConsumerMappings = [{
  eventhubResourceId:'/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.EventHub/namespaces/ehns-icm-srevent-${env}-ccan/eventhubs/srchange'
...
param pkustoManagedPrivateEndpointConnectionMapping = [{
  ...
  resourceId: '/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.EventHub/namespaces/ehns-icm-srevent-${env}-ccan'
}
{
  kustoConnectionKind: 'CosmosDb'
  managePrivateEndpointName: 'mpe-ratiolinkage-cosmos'
  message: 'Please approve the connection'
  resourceId: '/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.DocumentDB/databaseAccounts/csms-caiglobal-${env}-cm'
}]
param PdeployKustoManagedPrivateEndpoint = 'true'

param PcosmodbresourceIdsPrincipleMappings = [{
  cosmosDbAccountResourceId: '/subscriptions/443efde9-a0c0-4d0e-8f52-63cdcd9e0931/resourceGroups/rg-caiglobal-${env}-canadacentral/providers/Microsoft.DocumentDB/databaseAccounts/csms-caiglobal-${env}-cm'
  roleDefinitionId: '00000000-0000-0000-0000-000000000001'
  principleId: '1ba73227-e874-4142-85f6-00b19bc8013a' //change
  appName: 'icmratio'
...
param PkustoResourceIdsPrincipleMappings =  [{kustoDatabaseName:'ICMRatioData',principleid:'be55f430-c2ad-4523-88f4-8f97b0d7237e',tenantid:'72f988bf-86f1-41af-91ab-2d7cd011db47',role:'Admin',principleType:'User'},{kustoDatabaseName:'ICMRatioData',principleid:'21ca88c9-f159-4c8e-8264-a7fa3855d542',tenantid:'72f988bf-86f1-41af-91ab-2d7cd011db47',role:'Admin',principleType:'User'},{kustoDatabaseName:'ICMRatioData',principleid:'6133c548-bcad-470f-b0ed-28d7710be79f',tenantid:'33e01921-4d64-4f8c-a055-5bdaffd5e33d',role:'Admin',principleType:'App'},{kustoDatabaseName:'SupportValidationData',principleid:'6133c548-bcad-470f-b0ed-28d7710be79f',tenantid:'33e01921-4d64-4f8c-a055-5bdaffd5e33d',role:'Admin',principleType:'App'}]
